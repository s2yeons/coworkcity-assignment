  ...
  return (
    <main className="flex-1 bg-white">
      <section className="relative overflow-hidden bg-brand-900 text-white">
        <div
          aria-hidden="true"
          className="absolute inset-0 bg-[radial-gradient(700px_circle_at_8%_10%,rgba(100,171,136,0.6),transparent_60%),radial-gradient(600px_circle_at_95%_0%,rgba(245,233,184,0.55),transparent_55%),radial-gradient(800px_circle_at_88%_95%,rgba(100,171,136,0.75),transparent_60%),radial-gradient(550px_circle_at_20%_100%,rgba(255,105,0,0.28),transparent_55%)]"
        />
        <div
          aria-hidden="true"
        ...
        />
        <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" className="pointer-events-none absolute left-[42%] top-[12%] size-6 -rotate-6 text-white/10">
          <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5A2.5 2.5 0 1 1 12 6.5a2.5 2.5 0 0 1 0 5z" />
        </svg>
        <svg aria-hidden="true" viewBox="0 0 24 24" fill="currentColor" className="pointer-events-none absolute bottom-[16%] right-[16%] size-8 rotate-12 text-white/10">
          <path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5A2.5 2.5 0 1 1 12 6.5a2.5 2.5 0 0 1 0 5z" />
        </svg>
        <div aria-hidden="true" className="pointer-events-none absolute -right-16 top-1/4 size-[420px] rounded-full bg-white/10 blur-3xl animate-float" />
        <div aria-hidden="true" className="pointer-events-none absolute -bottom-32 right-1/4 size-[360px] rounded-full bg-cream-2/20 blur-3xl animate-float-slow" />

        <div className="relative mx-auto flex min-h-130 w-full max-w-[1280px] flex-col justify-center px-4 py-24 sm:px-6 lg:min-h-155 lg:px-10 lg:py-28">
